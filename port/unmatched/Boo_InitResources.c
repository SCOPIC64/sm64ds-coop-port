 ...
 * tools/closestplayer_guard.py cannot tell a bare `()` declaration from a
 * zero-argument call, and the guard's remedy is this copy. No other text
 * differs; diff against the src TU to verify.
 */
