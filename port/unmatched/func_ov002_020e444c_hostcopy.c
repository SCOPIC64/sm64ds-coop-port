/* HOST COPY of src/func_ov002_020e444c.c -- one ABI ride-through made
 * explicit: the matched code calls func_ov002_020e3f90() argless because
 * r0 still holds `c` on the DS; the host must pass it. */
#include "types.h"
...
void func_ov002_020e444c(char *c)
{
    ...
    if (((int (*)(char *))func_ov002_020e3f90)(c) == 0) {
