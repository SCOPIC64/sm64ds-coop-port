...
extern void _ZN4dBgW6EnableEP8dActor_c(struct dBgW_Kc* thiz, struct Actor* a);
...
void _ZN5Stage18LoadClsnAndObjectsER11LVL_OverlayjR12MeshCollider(struct LVL_Overlay_s* ovl, unsigned int p, struct dBgW_Kc* mc)
{
    struct KCL_File* f;
    struct LVL_SubTbl* e;
    signed char i;
    ...
    if (ovl->kclFileId != 0) {
        ...
        _ZN4dBgW6EnableEP8dActor_c(mc, 0);
    }
