 ...
 *     case 0: _ZN7Tornado6State0Ev(); break;
 *     case 1: _ZN7Tornado6State1Ev(); break;
 *     case 2: _ZN7Tornado6State2Ev(); break;
 * -- with NO ARGUMENTS, while all three bodies take a receiver:
 *     src/_ZN7Tornado6State0Ev.cpp   void _ZN7Tornado6State0Ev(void *self)
 *     src/_ZN7Tornado6State1Ev.cpp void _ZN7Tornado6State1Ev(char *c)
 *     src/_ZN7Tornado6State2Ev.cpp   void _ZN7Tornado6State2Ev(Actor *thiz)
 ...
 */
void _ZN7Tornado6State0Ev(void *self);
void _ZN7Tornado6State1Ev(void *self);
void _ZN7Tornado6State2Ev(void *self);
void *_ZN8dActor_c10FindWithIDEj(unsigned int id);
void *_ZN8dActor_c18ClosestWithActorIDEj(void *actor, unsigned int id);
...
int _ZN7Tornado8BehaviorEv(void *selfv)
{
    ...
    switch (s) {
    case 0: _ZN7Tornado6State0Ev(c); break;
    case 1: _ZN7Tornado6State1Ev(c); break;
    case 2: _ZN7Tornado6State2Ev(c); break;
    }
    {
    ...
    }
    {
        ...
        if (id != 0 && (*(int *)(c + 0x0f4) & 0x400000) != 0) {
            ...
            if (o != 0) {
                void *closest = _ZN8dActor_c18ClosestWithActorIDEj(c, 0x135);
                if (closest == 0 ||
    ...
    _ZN5dCc_c5ClearEv(c + 0xd4);      /* mMovingCylinderClsn */
