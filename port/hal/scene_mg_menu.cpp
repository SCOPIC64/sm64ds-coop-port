 ...
 * dScMiniGm_c_classInit's first word is e92d4010 (push {r4, lr}) and
 * _ZN11dScMiniGm_c8BehaviorEv's is the same.
 *
 ...
 *
 * _ZN11dScMiniGm_c6RenderEv, the Render slot, carries
 *
...
/* RE-POINTED at ALIAS2 (wave 8, the main -> port sync), lane ALIAS's
   ...
   was: #pragma comment(linker, "/alternatename:?SaveMinigames@SaveData@@YAXPAUMinigameSaveData@@@Z=__ZN8SaveData13SaveMinigamesEP16MinigameSaveData") */
#pragma comment(linker, "/alternatename:?SaveMinigames@SaveData@@YAXPAUMinigameSaveData@@@Z=?SaveMinigames@SaveData@@SAHPAUMinigameSaveData@@@Z")

extern "C" {

/* the mount (port/ov005_syms.txt, generated by tools/ovdata.py) */
extern unsigned char g_profile_MINIGAME[];   /* SpawnInfo, 8 bytes           */
...
int   _ZN11dScMiniGm_c13InitResourcesEv(void *self);        /* slot  0  InitResources     */
int   _ZN11dScMiniGm_c16CleanupResourcesEv(void *self);        /* slot  3  CleanupResources  */
int   _ZN11dScMiniGm_c8BehaviorEv(char *self);        /* slot  6  Behavior          */
int   _ZN11dScMiniGm_c6RenderEv(void *self);        /* slot  9  Render            */
void  _ZN11dScMiniGm_c16OnPendingDestroyEv(void);              /* slot 12  OnPendingDestroy  */
...
{ ++g_mgm_hits[0];  return _ZN11dScMiniGm_c13InitResourcesEv(s); }
static int  __fastcall mgm_clean(void *s, void *)
{ ++g_mgm_hits[3];  return _ZN11dScMiniGm_c16CleanupResourcesEv(s); }
static int  __fastcall mgm_beh(void *s, void *)
{ ++g_mgm_hits[6];  return _ZN11dScMiniGm_c8BehaviorEv((char *)s); }
static int  __fastcall mgm_render(void *s, void *)
{ ++g_mgm_hits[9];  return _ZN11dScMiniGm_c6RenderEv(s); }
static int  __fastcall mgm_render_noop(void *, void *)
{ ++g_mgm_hits[9];  return 1; }
static void __fastcall mgm_pdes(void *, void *)
{ ++g_mgm_hits[12]; _ZN11dScMiniGm_c16OnPendingDestroyEv(); }
static void *__fastcall mgm_d2(void *s, void *)
{ ++g_mgm_hits[16]; return (void *)_ZN11dScMiniGm_cD1Ev((int *)s); }
static void *__fastcall mgm_d0(void *s, void *)
{ ++g_mgm_hits[17]; return _ZN11dScMiniGm_cD0Ev(s); }
...
extern "C" void *port_mgm_spawn(void) { return dScMiniGm_c_classInit(); }
