...
// spells it _ZN10dBgActor_cD1Ev, the same D1/D2 spelling note the
// MeshColliderBase seat carries), slot 17 the deleting destructor
// _ZN10dBgActor_cD0Ev, and slot 31 Platform::Kill, which is already linked.
// Both destructor TUs are clean flat-C matched src (src/actors/dBgActor_c.cpp,
// src/actors/dBgActor_c.cpp); until this seat they were in no slice, so the two
...
// object: _ZTV10dBgActor_c (hal/actor_classes.cpp) and _ZTV10dBgActor_c
...
extern void *_ZTV10dBgActor_c[32];      /* storage: hal/actor_vtables.cpp */

int *_ZN10dBgActor_cD1Ev(int *self);    /* slot 16 body, complete (ov002 0x020ee42c) */
int *_ZN10dBgActor_cD0Ev(int *self);    /* slot 17 body, deleting (ov002 0x020ee464) */
...
{ return (int)(__int64)_ZN10dBgActor_cD1Ev((int *)s); }
static int __fastcall plat_d0(void *s, void *)
{ return (int)(__int64)_ZN10dBgActor_cD0Ev((int *)s); }
