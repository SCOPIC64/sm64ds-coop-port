...
// registers level 1 (ov009, the castle grounds) against port_ov009_mount,
// which already has exactly that shape. Every other level answers "not
// mounted in this build" and the handoff declines the change with a message
// instead of booting into null.
//
