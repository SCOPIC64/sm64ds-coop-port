...
int _ZN13daObjWakame_c13InitResourcesEv(char *self);   /* slot 0  InitResources */
int _ZN13daObjWakame_c16CleanupResourcesEv(void);         /* slot 3  CleanupResources */
int _ZN13daObjWakame_c8BehaviorEv(void *self);   /* slot 6  Behavior */
int *_ZN13daObjWakame_cD1Ev(int *self);   /* slot 16 D1 */
int *_ZN13daObjWakame_cD0Ev(int *self);   /* slot 17 D0 */
void *daObjWakame_c_classInit(void);
...
//
// src/game/actors/d_a_obj_wakame.cpp dispatches Render through a local six-virtual
...
//     mov r0, #1 / bx lr
//
// This body is byte-identical to _ZN12HealingHeart6RenderEv in
...
// _ZN13daObjWakame_c6RenderEv does not appear in walk_window.map as a separate name;
...
int _ZN13daObjWakame_c6RenderEv(void *selfv)
{
    char *c = (char *)selfv;
...
{ return _ZN13daObjWakame_c13InitResourcesEv((char *)s); }
static int __fastcall wk_clean(void *s, void *)
{ return _ZN13daObjWakame_c16CleanupResourcesEv(); }
static int __fastcall wk_behavior(void *s, void *)
{ return _ZN13daObjWakame_c8BehaviorEv(s); }
static int __fastcall wk_render(void *s, void *)
{
    port_actor_render_probe("SEAWEED", (char *)s + 0xd4);
    return _ZN13daObjWakame_c6RenderEv(s);
}
static int __fastcall wk_d1(void *s, void *)
{ return (int)(size_t)_ZN13daObjWakame_cD1Ev((int *)s); }
static int __fastcall wk_d0(void *s, void *)
{ return (int)(size_t)_ZN13daObjWakame_cD0Ev((int *)s); }
