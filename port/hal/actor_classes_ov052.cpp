...
// and slot 31 is 0x020ee55c, _ZN10dBgActor_c4KillEv, the tail every 32-slot
...
//
// src/game/actors/d_a_obj_emm_log.cpp (id 174's CleanupResources) spells ov052's own file
...
// target 0x021124d4 module:overlay(52). Its sibling _ZN13daObjEmmLog_c13InitResourcesEv spells
...
/* The two RTTI spellings the destructors restore their tables by. id 174's D1
   (_ZN13daObjEmmLog_cD1Ev) writes _ZTV13daObjEmmLog_c and then the zeroed
...
/* ONE C++-MANGLED DATA SPELLING, the IDENTITY_MATRIX4X3 / data_020a0e68 precedent.
   src/game/actors/d_a_obj_emm_log.cpp declares id 174's file table at FILE SCOPE as
   ...
   C-named array. Its sibling _ZN13daObjEmmLog_c16CleanupResourcesEv reaches the SAME twelve bytes
...
extern "C" {
int _ZN13daObjEmmLog_c13InitResourcesEv(char *self);   /* slot 0  InitResources */
int _ZN13daObjEmmLog_c16CleanupResourcesEv(char *self);   /* slot 3  CleanupResources */
int _ZN13daObjEmmLog_c8BehaviorEv(char *self);   /* slot 6  Behavior */
int _ZN13daObjEmmLog_c6RenderEv(void *self);   /* slot 9  Render */
int *_ZN13daObjEmmLog_cD1Ev(int *self);   /* slot 16 D1 */
int *_ZN13daObjEmmLog_cD0Ev(int *self);   /* slot 17 D0 */
void *daObjEmmLog_c_classInit(void);       /* the factory */
DSSTATE_BEGIN
void *_ZTV13daObjEmmLog_c[32];
DSSTATE_END
}
static int __fastcall log_init(void *s, void *)
{ return _ZN13daObjEmmLog_c13InitResourcesEv((char *)s); }
static int __fastcall log_clean(void *s, void *)
{ return _ZN13daObjEmmLog_c16CleanupResourcesEv((char *)s); }
static int __fastcall log_behavior(void *s, void *)
{ return _ZN13daObjEmmLog_c8BehaviorEv((char *)s); }
static int __fastcall log_render(void *s, void *)
{ port_actor_render_probe("BOBBING_LOG_EMM", (char *)s + 0xd4);
  return _ZN13daObjEmmLog_c6RenderEv(s); }
static int __fastcall log_d1(void *s, void *)
{ return (int)(size_t)_ZN13daObjEmmLog_cD1Ev((int *)s); }
static int __fastcall log_d0(void *s, void *)
{ return (int)(size_t)_ZN13daObjEmmLog_cD0Ev((int *)s); }
extern "C" void hal_fill_bobbing_log_emm_vtable(void)
{
    port_ov52_bringup();
    void *volatile *vt = (void *volatile *)_ZTV13daObjEmmLog_c;
    ov52_fill_shared(vt);
    vt[0]  = (void *)log_init;
    vt[3]  = (void *)log_clean;
...
void *daObjEmmYuka_c_classInit(void);
DSSTATE_BEGIN
