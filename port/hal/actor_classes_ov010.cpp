...
//   2. THE FACTORIES' OWN LITERAL POOLS. daObjC1_Trap_c_classInit (0x02111998, the factory
//      g_profile_C1_TRAP's word[0] relocates to, whose +4 halfword reads 36) loads
//      0x02112ae4 at pool word 0x021119cc. daObjC1Hikari_c_classInit (0x02111dd0, id 37)
...
//      0x02111e0c (daObjC1Hikari_c_classInit). The two sets do not intersect.
//   4. THE SLOTS THEMSELVES. 0x02112ae4 slot 0 is _ZN14daObjC1_Trap_c13InitResourcesEv;
//      0x02112ba8 slot 0 is _ZN9LightBeam13InitResourcesEv. Different bodies.
//
...
//
// THE TABLE. _ZTV14daObjC1_Trap_c, 32 slots. The reloc run covers
...
//
//   slot 0   0x02112ae4 -> 0x02111654  _ZN14daObjC1_Trap_c13InitResourcesEv  0x1f8  InitResources
//   slot 3   0x02112af0 -> 0x02111554  _ZN14daObjC1_Trap_c16CleanupResourcesEv  0x54   CleanupResources
//   slot 6   0x02112afc -> 0x021115e0  _ZN14daObjC1_Trap_c8BehaviorEv  0x74   Behavior
//   slot 9   0x02112b08 -> 0x021115a8  _ZN14daObjC1_Trap_c6RenderEv  0x38   Render
//   slot 16  0x02112b24 -> 0x021111a0  _ZN14daObjC1_Trap_cD1Ev  0x4c   D1
//   slot 17  0x02112b28 -> 0x021111ec  _ZN14daObjC1_Trap_cD0Ev  0x60   D0
//
...
// FROM THE RELOC, NEVER FROM THE COMMENT: src/game/actors/d_a_obj_c1_trap.cpp is headed
...
int  _ZN14daObjC1_Trap_c13InitResourcesEv(char *self);   /* slot 0  */
int  _ZN14daObjC1_Trap_c16CleanupResourcesEv(char *self);   /* slot 3  */
int  _ZN14daObjC1_Trap_c8BehaviorEv(void *self);   /* slot 6  */
int  _ZN14daObjC1_Trap_c6RenderEv(char *self);   /* slot 9  */
int *_ZN14daObjC1_Trap_cD1Ev(int *self);    /* slot 16 */
int *_ZN14daObjC1_Trap_cD0Ev(int *self);    /* slot 17 */
...
void _ZN14daObjC1_Trap_c6State0Ev(char *c);          /* state 0 */
void _ZN14daObjC1_Trap_c6State1Ev(char *c);          /* state 1 */
void _ZN14daObjC1_Trap_c6State2Ev(int c);            /* state 2 */
void _ZN14daObjC1_Trap_c6State3Ev(unsigned char *c); /* state 3 */
void _ZN14daObjC1_Trap_c6State4Ev(char *c);          /* state 4 */
...
/* THE HOST TABLE. `int` and C linkage because include/decl_common.h declares
   ...
   and src/game/actors/d_a_obj_c1_trap.cpp spells it the same way. Inside DSSTATE because it is a
...
/* THE TWO SharedFilePtr NAMES slot 3 spells are dsd cross-overlay misnames.
   src/game/actors/d_a_obj_c1_trap.cpp says data_ov025_02112d08 and data_ov024_02112d00;
...
static int  __fastcall ov10_binit(void *s, void *)  { return _ZN8dActor_c19BeforeInitResourcesEv(s); }
static void __fastcall ov10_ainit(void *s, void *, unsigned a) { _ZN8dActor_c18AfterInitResourcesEj(s, a); }
static int  __fastcall ov10_bclean(void *s, void *) { return ((dActor_c *)s)->dActor_c::BeforeCleanupResources(); }
static void __fastcall ov10_aclean(void *s, void *, unsigned a) { ((fBase_c *)s)->fBase_c::AfterCleanupResources(a); }
static int  __fastcall ov10_bbeh(void *s, void *)   { return _ZN8dActor_c14BeforeBehaviorEv(s); }
static void __fastcall ov10_abeh(void *s, void *, unsigned a) { ((fBase_c *)s)->fBase_c::AfterBehavior(a); }
static int  __fastcall ov10_bren(void *s, void *)   { return _ZN8dActor_c12BeforeRenderEv(s); }
static void __fastcall ov10_aren(void *s, void *, unsigned a) { ((fBase_c *)s)->fBase_c::AfterRender(a); }
static int  __fastcall ov10_pdes(void *s, void *)   { ((fBase_c *)s)->fBase_c::OnPendingDestroy(); return 0; }
static int  __fastcall ov10_heap(void *s, void *)   { return ((fBase_c *)s)->fBase_c::OnHeapCreated(); }
static int  __fastcall ov10_yoshi(void *s, void *)  { return _ZN8dActor_c13OnYoshiTryEatEv(s); }
static int  __fastcall ov10_turn_egg(void *s, void *, void *p) { _ZN8dActor_c13OnTurnIntoEggER6Player(s, p); return 0; }
static int  __fastcall ov10_v50(void *s, void *)    { return _ZN8dActor_c9Virtual50Ev(s); }
static int  __fastcall ov10_pounded(void *s, void *, void *o) { _ZN8dActor_c15OnGroundPoundedERS_(s, o); return 0; }
static int  __fastcall ov10_atk1(void *s, void *, void *o) { _ZN8dActor_c11OnAttacked1ERS_(s, o); return 0; }
static int  __fastcall ov10_atk2(void *s, void *, void *o) { _ZN8dActor_c11OnAttacked2ERS_(s, o); return 0; }
static int  __fastcall ov10_kicked(void *s, void *, void *o) { _ZN8dActor_c8OnKickedERS_(s, o); return 0; }
static int  __fastcall ov10_pushed(void *s, void *, void *o) { _ZN8dActor_c8OnPushedERS_(s, o); return 0; }
static int  __fastcall ov10_cannon(void *s, void *, void *o) { _ZN8dActor_c24OnHitByCannonBlastedCharERS_(s, o); return 0; }
static int  __fastcall ov10_mega(void *s, void *, void *p) { _ZN8dActor_c15OnHitByMegaCharER6Player(s, p); return 0; }
static int  __fastcall ov10_under(void *s, void *, void *o) { _ZN8dActor_c19OnHitFromUnderneathERS_(s, o); return 0; }
static int  __fastcall ov10_egg(void *s, void *)    { return _ZN8dActor_c16OnAimedAtWithEggEv(s); }
static int  __fastcall ov10_kill(void *s, void *)   { _ZN10dBgActor_c4KillEv(s); return 0; }
...
static void __fastcall t36_state0(void *s, void *) { _ZN14daObjC1_Trap_c6State0Ev((char *)s); }
static void __fastcall t36_state1(void *s, void *) { _ZN14daObjC1_Trap_c6State1Ev((char *)s); }
static void __fastcall t36_state2(void *s, void *) { _ZN14daObjC1_Trap_c6State2Ev((int)(size_t)s); }
static void __fastcall t36_state3(void *s, void *) { _ZN14daObjC1_Trap_c6State3Ev((unsigned char *)s); }
static void __fastcall t36_state4(void *s, void *) { _ZN14daObjC1_Trap_c6State4Ev((char *)s); }
...
static int __fastcall t36_init(void *s, void *)  { return _ZN14daObjC1_Trap_c13InitResourcesEv((char *)s); }
static int __fastcall t36_clean(void *s, void *) { return _ZN14daObjC1_Trap_c16CleanupResourcesEv((char *)s); }
static int __fastcall t36_beh(void *s, void *)   { return _ZN14daObjC1_Trap_c8BehaviorEv(s); }
static int __fastcall t36_ren(void *s, void *)
{ port_actor_render_probe("TRAP", (char *)s + 0x320);
  return _ZN14daObjC1_Trap_c6RenderEv((char *)s); }
static int __fastcall t36_d1(void *s, void *)    { return (int)(size_t)_ZN14daObjC1_Trap_cD1Ev((int *)s); }
static int __fastcall t36_d0(void *s, void *)    { return (int)(size_t)_ZN14daObjC1_Trap_cD0Ev((int *)s); }

extern "C" void hal_fill_ov010_trap36_vtable(void)
{
    /* TRAP is Platform-derived (daObjC1_Trap_c_classInit runs Platform's C2 and builds a
    ...
    void **vt = (void **)_ZTV14daObjC1_Trap_c;
    vt[0]  = (void *)t36_init;
