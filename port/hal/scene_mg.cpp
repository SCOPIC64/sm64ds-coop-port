...
/* run link100 lane PMFB5: the five remaining ov006 single-row tables */
void port_mg_cup_states_seat(void);         /* unmatched/MgCup_StateDispatch.cpp */
void port_mg_curling2_states_seat(void);    /* unmatched/MgCurling2_StateDispatch.cpp */
...
extern "C" void port_scene_mg_overlay_load(void)
{
    ...
    port_mg_cup_states_seat();
    port_mg_curling2_states_seat();
