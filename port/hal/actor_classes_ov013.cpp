...
// _ZTV18daObjClockHuriko_c (RTTI _ZTV18daObjClockHuriko_c), split five ways by
...
int _ZN18daObjClockHuriko_c13InitResourcesEv(char *self);       /* slot 0, InitResources */
int _ZN18daObjClockHuriko_c16CleanupResourcesEv(void);             /* slot 3, CleanupResources
                                               (releases the global SFP,
                                               ignores this) */
int _ZN18daObjClockHuriko_c8BehaviorEv(char *self);       /* slot 6, Behavior (the swing) */
int _ZN18daObjClockHuriko_c6RenderEv(void *self);       /* slot 9, Render (from src,
                                               plain-Model slot-5) */
void *daObjClockHuriko_c_classInit(void);   /* installs _ZTV18daObjClockHuriko_c */
DSSTATE_BEGIN
int _ZTV18daObjClockHuriko_c[31];               /* Pendulum's own vtable, unnamed
...
int _ZN12daObjClock_c13InitResourcesEv(void *self);    /* slot 0 */
int *_ZN12daObjClock_cD0Ev(int *self);                 /* slot 17, .c, DTOR-PAIRS seat (0x021113ec) */
int _ZN12daObjClock_c16CleanupResourcesEv(void *self); /* slot 3 */
int _ZN12daObjClock_c8BehaviorEv(void *self);          /* slot 6 */
int _ZN12daObjClock_c6RenderEv(void *self);            /* slot 9 */
void *daObjClock_c_classInit_CLOCK_SHORT(void);
void *daObjClock_c_classInit_CLOCK_LONG(void);   /* installs the SAME table */
...
{ return _ZN18daObjClockHuriko_c13InitResourcesEv((char *)s); }
static int __fastcall cp_clean(void *s, void *)
{ (void)s; return _ZN18daObjClockHuriko_c16CleanupResourcesEv(); }
static int __fastcall cp_behavior(void *s, void *)
{ return _ZN18daObjClockHuriko_c8BehaviorEv((char *)s); }
static int __fastcall cp_render(void *s, void *)
{ port_actor_render_probe("CLOCK_PENDULUM", (char *)s + 0xd4);
  return _ZN18daObjClockHuriko_c6RenderEv(s); }
/* D1/D0 host thunks: the matched src (_ZN18daObjClockHuriko_cD1Ev.c/021111d0.c --
...
/* SLOT 16 IS THE MATCHED TU NOW, run link100 lane TAIL, and this one is the
   ...
   transcription of src/game/actors/d_a_obj_clock_huriko.cpp that diverged from it in NOTHING.
   The ROM body's only pooled word is _ZTV18daObjClockHuriko_c (reloc 0x021111cc),
   ...
   the one that did not: the matched D0 (_ZN18daObjClockHuriko_cD0Ev) carries the
...
extern "C" int *_ZN18daObjClockHuriko_cD1Ev(int *t);   /* ov013 0x021111a0, slot 16 */
extern "C" int *_ZN18daObjClockHuriko_cD0Ev(int *t);   /* ov013 0x021111d0, slot 17 */
static int __fastcall cp_d1(void *s, void *)
{ return (int)(size_t)_ZN18daObjClockHuriko_cD1Ev((int *)s); }
static int __fastcall cp_d0(void *s, void *)
{ return (int)(size_t)_ZN18daObjClockHuriko_cD0Ev((int *)s); }

extern "C" void hal_fill_clock_pendulum_vtable(void)
{
    void *volatile *vt = (void *volatile *)_ZTV18daObjClockHuriko_c;
    ov13_fill_shared(vt);
    vt[0]  = (void *)cp_init;
    vt[3]  = (void *)cp_clean;
...
{ return (int)(size_t)_ZN12daObjClock_cD0Ev((int *)s); }
...
// ClockPaintingHandShort.h (?InitResources@daObjClock_c@@..., not
...
extern "C" {
int _ZN12daObjClock_c13InitResourcesEv(void *self)
{ return ((daObjClock_c *)self)->daObjClock_c::InitResources(); }
int _ZN12daObjClock_c16CleanupResourcesEv(void *self)
{ return ((daObjClock_c *)self)->daObjClock_c::CleanupResources(); }
int _ZN12daObjClock_c8BehaviorEv(void *self)
{ return ((daObjClock_c *)self)->daObjClock_c::Behavior(); }
int _ZN12daObjClock_c6RenderEv(void *self)
{ return ((daObjClock_c *)self)->daObjClock_c::Render(); }
}
