...
// ---- THE HIERARCHY MAP -----------------------------------------------------
//
//   ActorBase -> Actor -> Platform          _ZTV10dBgActor_c    0x0210ae38, 32
...
// _ZN16dPathLiftActor_c9AfterClsnEi (0x020eff18). daObjPathLift_c inherits that slot
...
//                        _ZTS9daSCoin_c = base + 0x84 = 33 words exactly
...
//    0    ActorBase::InitResources         _ZN15daObjPathLift_c13InitResourcesEv
//    3    ActorBase::CleanupResources      _ZN15daObjPathLift_c16CleanupResourcesEv
//    6    ActorBase::Behavior              _ZN15daObjPathLift_c8BehaviorEv
//    9    ActorBase::Render                _ZN15daObjPathLift_c6RenderEv
//   16    _ZN16dPathLiftActor_cD1Ev  0x020ef390     _ZN15daObjPathLift_cD1Ev
//   17    _ZN16dPathLiftActor_cD0Ev  0x020ef320     _ZN15daObjPathLift_cD0Ev
...
// runs __cxa_vec_cleanup with an explicit function pointer). Its slots 0/3/6/9
...
// daObjPathLift_c_classInit 0x02147328 (0x7c): ActorBase::new(0x4b4), Platform::Platform,
...
// src/minigames/d_s_mg_jump2.cpp is NOT this class's base init. That
...
int _ZN15daObjPathLift_c8BehaviorEv(void *self);               /* slot 6  */
int _ZN15daObjPathLift_c6RenderEv(void *self);               /* slot 9  */
int _ZN15daObjPathLift_cD1Ev(void *self);               /* slot 16 */
void *_ZN15daObjPathLift_cD0Ev(void *self);             /* slot 17 */
void *daObjPathLift_c_classInit(void);
...
/* RETIRED at ALIAS2 (wave 8, the main -> port sync). DEAD RHS and an UNREFERENCED left hand side: nothing in the build defines ?Enable@dBgW@@QAEHPAUActor@@@Z, and nothing references ?Enable@dBgW@@QAEXPAX@Z, so the row can never fire and nothing wants it to. */
// #pragma comment(linker, "/alternatename:?Enable@dBgW@@QAEXPAX@Z=?Enable@dBgW@@QAEHPAUActor@@@Z")
/* THE THREE SHARED-HEADER ROLE NAMES, the CannonHatch disease's third case.
   src/game/actors/daObjPathLift_c.cpp releases its SharedFilePtrs as G0/G1/G2, and
...
// (?BaseBehavior@dPathLiftActor_c@@QAEXXZ) sits beside its host body in
...
extern "C" {
int _ZN10dBgActor_c19UpdateClsnPosAndRotEv(void *self);
...
/* slot 32: the extra virtual PathLiftActor_c adds. BOTH tables carry the
   ...
   PathLift::AfterClsn takes VOID in the ROM (_ZN16dPathLiftActor_c9AfterClsnEi,
...
{ return _ZN16dPathLiftActor_cD1Ev(s); }
static int __fastcall plb_d0(void *s, void *)
{ return _ZN16dPathLiftActor_cD0Ev(s); }
