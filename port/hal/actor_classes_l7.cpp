...
L7_TRAP(13) L7_TRAP(14) L7_TRAP(16) L7_TRAP(17)
#undef L7_TRAP
...
// _ZN10dBgActor_c4KillEv (ov002 0x020ee55c, already in the build). daDsn_c_classInit
...
//
// THE FACTORY LEAVES THE VPTR ON A PLACEHOLDER. daDsn_c_classInit's last line stores
...
// _ZTV11daDsnBase_c, which the ov091 mount carries; the alias below points the
// wildcard name at it.
//
...
int _ZN11daDsnBase_c16CleanupResourcesEv(void *self);    /* face: below */
int _ZN6Thwomp8BehaviorEv(void *self);             /* face: below */
int _ZN11daDsnBase_c6RenderEv(void *self);               /* face: below */
int *_ZN6ThwompD1Ev(int *self);                    /* .c, C linkage */
int *_ZN6ThwompD0Ev(int *self);                    /* .c, C linkage */
void _ZN6Thwomp15OnHitByMegaCharER6Player(void *self, void *o);     /* slot 27, its own */
int _ZN6Thwomp16OnAimedAtWithEggEv(void *self);               /* slot 29, its own */
void _ZN10dBgActor_c4KillEv(void *self);              /* slot 31 */
void *_ZTV6Thwomp[32];
extern unsigned char _ZTV11daDsnBase_c[];        /* daDsnBase_c base table */
...
#pragma comment(linker, "/alternatename:__ZTV7daDsn_c=__ZTV11daDsnBase_c")

/* daDsn_c_classInit leaves the vptr on VT1; reseat it onto the host table. */
extern "C" void *port_factory_thwomp(void)
{
    void *p = daDsn_c_classInit();
    if (p)
...
{ _ZN6Thwomp15OnHitByMegaCharER6Player(s, o); return 0; }
static int __fastcall thw_aimed(void *s, void *)
{ return _ZN6Thwomp16OnAimedAtWithEggEv(s); }
...
// ============================================================================
//
// daObjSimpleLift_c_classInit_BK_TRANSBAR (ov091 0x021327e8) installs 0x02135080 cleanly and its
...
// _ZN25RotatingUpDownPlatformUtm4KillEv, not ov002's Platform::Kill, and slot 27
// (_ZN25RotatingUpDownPlatformUtm15OnHitByMegaCharER6Player, OnHitByMegaChar) is its own too. 940-byte object with a
...
void _ZN25RotatingUpDownPlatformUtm15OnHitByMegaCharER6Player(void *self, void *o);   /* slot 27, its own */
void _ZN25RotatingUpDownPlatformUtm4KillEv(void *self);            /* slot 31, its own Kill */
...
/* ---- the Utm's own Kill (_ZN25RotatingUpDownPlatformUtm4KillEv) reaches three engine leaves ---
...
/* RETIRED at ALIAS2 (wave 8, the main -> port sync). DEFEATED: the left hand side is a real definition in this link now (_ZN8dActor_c10PoofDustAtERK7Vector3.cpp.obj), so the directive is inert and alternatename_guard fails on it. */
// #pragma comment(linker, "/alternatename:?PoofDustAt@dActor_c@@QAEXABUVector3@@@Z=?PoofDustAt@ActorPoofFace@@QAEXABUL7Vector3@@@Z")
namespace Sound {
void PlayBank3(unsigned id, const L7Vector3 &v);
void PlayBank3(unsigned id, const L7Vector3 &v)
{ _ZN5Sound9PlayBank3EjRK7Vector3(id, &v); }
}
/* RETIRED at ALIAS2 (wave 8, the main -> port sync). DEFEATED: the left hand side is a real definition in this link now (_ZN5Sound9PlayBank3EjRK7Vector3.cpp.obj), so the directive is inert and alternatename_guard fails on it. */
...
{ _ZN25RotatingUpDownPlatformUtm15OnHitByMegaCharER6Player(s, o); return 0; }
static int __fastcall rud_kill(void *s, void *)
{ _ZN25RotatingUpDownPlatformUtm4KillEv(s); return 0; }
...
// ============================================================================
//
// THE ov015 NAME SHIFT once more: daFPkn_c_classInit_PAKUN2 (ov084 0x0212ea18)
...
// well as the usual six: 18 (_ZN19FirePiranhaPlantBig13OnYoshiTryEatEv, OnYoshiTryEat), 19
// (_ZN19FirePiranhaPlantBig13OnTurnIntoEggER6Player, OnTurnIntoEgg) and 29 (_ZN19FirePiranhaPlantBig16OnAimedAtWithEggEv,
...
int _ZN19FirePiranhaPlantBig13OnYoshiTryEatEv(void *self);              /* slot 18, its own */
void _ZN19FirePiranhaPlantBig13OnTurnIntoEggER6Player(void *self, void *p);    /* slot 19, its own */
int _ZN19FirePiranhaPlantBig16OnAimedAtWithEggEv(void *self);              /* slot 29, its own */
...
{ return _ZN19FirePiranhaPlantBig13OnYoshiTryEatEv(s); }
static int __fastcall fpir_egg(void *s, void *, void *p)
{ _ZN19FirePiranhaPlantBig13OnTurnIntoEggER6Player(s, p); return 0; }
static int __fastcall fpir_aimed(void *s, void *)
{ return _ZN19FirePiranhaPlantBig16OnAimedAtWithEggEv(s); }
...
// ============================================================================
//
// daPkn_c_classInit (ov084 0x02130110) installs _ZTV12PiranhaPlant cleanly and
...
// slot 29 (_ZN7daPkn_c16OnAimedAtWithEggEv, OnAimedAtWithEgg); slots 18/19 stay Actor's.
//
...
extern "C" {
int _ZN7daPkn_c13InitResourcesEv(void *self);    /* C-named in its own TU */
int _ZN7daPkn_c16CleanupResourcesEv(void *self);  /* face: below */
int _ZN7daPkn_c8BehaviorEv(void *self);           /* host copy */
int _ZN7daPkn_c6RenderEv(void *self);             /* host copy */
void _ZN7daPkn_c16OnPendingDestroyEv(void *self); /* slot 12, its own */
int *_ZN7daPkn_cD1Ev(int *self);                  /* .c */
int *_ZN7daPkn_cD0Ev(int *self);                  /* .c */
int _ZN7daPkn_c16OnAimedAtWithEggEv(void *self);              /* slot 29, its own */
...
#include "daPkn_c.h"
extern "C" {
int _ZN7daPkn_c16CleanupResourcesEv(void *self)
{ return ((daPkn_c *)self)->daPkn_c::CleanupResources(); }
}
