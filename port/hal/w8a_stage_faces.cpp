...
//       A DATA face, not a code one, and IT IS A CHAINED ALIAS. An earlier
//       revision of this note claimed _func_020aba70 was a real definition in
//       ov001_syms.c.obj; a review read the same map rows and showed the shape
//       is the FIRED-ALIAS one that alternatename_guard's own header
//       documents -- __ZN3OAM7NUMBERSE and _func_020aba70 share an address and
//       an object because hal/sub_actors.cpp:563 already aliases the second
//       onto the first. It resolves, but the invariant that keeps it resolving
//       is that live HUD TUs reference _func_020aba70 so the first alias
//       fires, NOT that anything defines it.
