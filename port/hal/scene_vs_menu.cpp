...
extern unsigned char g_profile_ENTRY[];      /* dScEntry_c SpawnInfo      */
extern unsigned char g_profile_ENTRY_OBJECT[]; /* 0x0211c610, {fn, 015a015a} */
...
void  _ZN10dScEntry_c16OnPendingDestroyEv(void);                 /* slot 12  OnPendingDestroy */
int   _ZN10dScEntry_cD1Ev(void *c);              /* slot 16  D2               */
int  *_ZN10dScEntry_cD0Ev(int *t);               /* slot 17  D0               */
void *dScEntry_c_classInit_ENTRY(void);                 /* the factory (matched src) */
 ...
 * dScEntry_c_classInit_RESULT, is dScEntry_c_classInit_ENTRY with a different pair of
 ...
 * branch: src/_ZN10dScEntry_c13InitResourcesEv.cpp does `if (self->unk_00c == 6)` for the
 ...
 *
 *     extern unsigned char g_profile_RESULT[];
 *     extern "C" void *port_vs_results_spawn(void)
 *         { return dScEntry_c_classInit_RESULT(); }
 ...
 *     {7, "SCENE_VS_RESULTS", g_profile_RESULT, port_vs_results_spawn,
...
#include "fBase_c.h"      /* the entry actor's shared-slot thunks */
#include "dBase_c.h"
...
/* THE FACES WERE ALSO THE DECLARATIONS, and that is why three of the seven
   ...
   below takes the ADDRESS of _ZN10dScEntry_c6icon_c6RenderEv, _0211705c, _0211867c and --
...
extern "C" {
void _ZN10dScEntry_c6icon_c6RenderEv(char *self);   /* src/_ZN10dScEntry_c6icon_c6RenderEv.cpp */
 ...
 *       <- _ZN10dScEntry_c13InitResourcesEv +0x1e7        dScEntry_c::InitResources
 ...
 * word, and vs_data_patch.inc row 231 is what wrote _ZN10dScEntry_c15graphCallback_c14GraphCallback2Ev into
 * its slot 2. src/_ZN10dScEntry_c15graphCallback_c14GraphCallback2Ev.cpp returns 1, so the port's display tail
...
extern "C" {
extern unsigned char _ZTVN10dScEntry_c15graphCallback_cE[];
}
...
static void vs_register_graph_block(void)
{
    ...
    if (e && e[0] == '0' && e[1] == '\0')
        return;
    void **vt = (void **)_ZTVN10dScEntry_c15graphCallback_cE;
    std::fprintf(stderr,
                 "  [r3h] scene 6's graphics block registered with the port's "
                 "beat: _ZTVN10dScEntry_c15graphCallback_cE at %p, vt[0..3]={%08X,%08X,%08X,"
                 "%08X} (slot 2 is _ZN10dScEntry_c15graphCallback_c14GraphCallback2Ev, the VS menu's own "
                 "display sync)\n",
 ...
 *
 *     FAULT code c0000005 accessing 00000005, _ZN10dScEntry_c6icon_c6RenderEv+0xa
 ...
 * (src/_ZN10dScEntry_c15graphCallback_c14GraphCallback2Ev.cpp) -> `if (c[8]) func_ov075_021160dc(c[8])` ->
 ...
 *           _ZN10dScEntry_c8BehaviorEv, whose banner says in as many words that it
 ...
 *           scene 6 moved its fault to _ZN10dScEntry_c6icon_c8BehaviorEv+0x7 reading
 ...
 * third way in: two references INTO _ZTVN10dScEntry_c6icon_cE (0x02115bc0 and
 * 0x0211a850, the constructors that install it as a vptr) and two out of it,
 * its own words.
 *
 * NEITHER BODY IS A GUESS: src/_ZN10dScEntry_c6icon_c6RenderEv.cpp and
 * src/_ZN10dScEntry_c6icon_c8BehaviorEv.cpp carry no "recovered from vtable slot identity"
...
extern "C" {
extern unsigned char _ZTVN10dScEntry_c6icon_cE[];
}
...
static void __fastcall vs_vt2_method1(void *self, void *)
{
    ...
    ++g_r3h_vt2_hits[1];
    _ZN10dScEntry_c6icon_c6RenderEv((char *)self);
}
static unsigned g_r3h_vt2_count(unsigned slot)
{
...
static void vs_install_vt2_faces(void)
{
    ...
    if (e && e[0] == '0' && e[1] == '\0')
        return;
    void **vt = (void **)_ZTVN10dScEntry_c6icon_cE;
    std::fprintf(stderr,
                 "  [r3h] the 0x0211c94c virtual table's SLOT 1 now gets its "
                 "receiver (-> _ZN10dScEntry_c6icon_c6RenderEv): "
...
{ ++g_vs_hits[0];  return _ZN10dScEntry_c13InitResourcesEv((char *)s); }
static int __fastcall vs_reset(void *s, void *)
{ /* IMPLICIT-REGISTER DEFECT, the eighth of its class: slot 1's matched
     veneer (src/_ZN10dScEntry_c19BeforeInitResourcesEv.cpp) is a void(void) tail-call and the
  ...
  ++g_vs_hits[1];  return _ZN8dScene_c19ResetFadersAndSoundEv(s); }
static int  __fastcall vs_clean(void *s, void *)
{ /* the body reads r0 the way the ROM handed it -- forward self */
  ++g_vs_hits[3];  return _ZN10dScEntry_c16CleanupResourcesEv((signed char)(long long)s); }
...
{ /* first-frame census: the two words every VS spawn hangs off. A null
  ...
  return _ZN10dScEntry_c8BehaviorEv(s); }
static int  __fastcall vs_render(void *s, void *)
{ ++g_vs_hits[9];  return _ZN10dScEntry_c6RenderEv(s); }
static void __fastcall vs_pdes(void *, void *)
{ ++g_vs_hits[12]; _ZN10dScEntry_c16OnPendingDestroyEv(); }
static void *__fastcall vs_d2(void *s, void *)
{ ++g_vs_hits[16]; _ZN10dScEntry_cD1Ev(s); return s; }
static void *__fastcall vs_d0(void *s, void *)
{ ++g_vs_hits[17]; return (void *)_ZN10dScEntry_cD0Ev((int *)s); }
...
extern "C" void *port_vs_spawn(void)       { return dScEntry_c_classInit_ENTRY(); }
extern "C" void *port_vs_entry_spawn(void) { return dEntObj_c_classInit(); }
...
extern "C" void port_scene_fill_vs(void)
{
    ...
    unsigned char *info = g_profile_ENTRY_OBJECT;
...
/* THREE arm9 TYPEINFO RECORDS, hosted as zeroed identity-only storage. The
   ...
   RTTI records are hosted for real:
     _ZTI7dBase_c   ActorBase-side base typeinfo (3 relocated words)
     _ZTIN8dGraph_c10callback_cE   the entry actor's base typeinfo (3 relocated words)
     _ZTI8dScene_c   Scene's typeinfo (3 relocated words) */
DSSTATE_BEGIN
unsigned char _ZTI7dBase_c[0xc];
unsigned char _ZTIN8dGraph_c10callback_cE[0x10];
unsigned char _ZTI8dScene_c[0xc];
DSSTATE_END
...
/* ShadowModel::InitModel, the ONE decorated spelling an alias cannot bridge:
   ...
   and forwards. */
/* main -> port sync (SYNC4). include/ShadowModel.h now declares this method
   itself, with the REAL Fix12<int> scale parameters the ROM symbol carries
   (`5Fix12IiES3_S3_`), so two things changed at once: the local shim became a
   C2011 redefinition, and the decoration every caller in the merged tree now
   asks for is the Fix12 one, not the HHHI spelling this file used to emit.
   The forwarder follows the header; the body is unchanged apart from reading
   .val out of each scale. */
...
void ShadowModel::InitModel(Matrix4x3 *m, Fix12<int> sx, Fix12<int> sy,
                            Fix12<int> sz, u32 d)
{
    _ZN11ShadowModel9InitModelEP9Matrix4x35Fix12IiES3_S3_j(
        this, m, sx.val, sy.val, sz.val, d);
}
