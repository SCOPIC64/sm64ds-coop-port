...
SCENE_BLOCKED = {
    1: ("the ov007 decomp (func_ov007_020c9688 is UNMATCHED)",
        ...
        "and 532 have a matched src TU; func_ov007_020c9688 (0x020c9688, 768 "
        "bytes) is one of the sixteen that do not, there is no C for it "
        "anywhere in the tree, and hal/scene_boot.cpp stands a named trap "
        "there rather than a guessed body. (528 and twenty until run link60's "
        "port-catchup lane took four ov007 bodies the decomp had matched after "
        "this branch forked; this blocker was not one of them and is still "
        "unmatched on main. scene_boot.cpp section 3a is the other half of the "
        "same figures and the two must move together.) InitResources reaches "
        "it through "
