...
| `CleanupResources` tail call | literal at `0x02111bd4` | `0x020b6424` = [func_ov002_020b6424](../../../include/daObjUkiyuka_c.h)(ROM Ordinal 0 used to assemble `daObjUkiyuka_c.cpp`) |
| `InitResources` tail call | literal at `0x02111bec` | `0x020b6584` = [func_ov002_020b6584](../../../include/daObjUkiyuka_c.h)(ROM Ordinal 3 used to assemble `daObjUkiyuka_c.cpp`) |
