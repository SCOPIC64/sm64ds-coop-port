# Historical writer measurements (reference only)

Operational instructions are superseded by [the current protocol](../PIPELINE.md)
and [producer role](../roles/producer.md). Search this file for a specific compiler
case; its old launch, claim, path, and completion rules are not the active workflow.
