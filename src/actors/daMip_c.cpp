...
/* MSVC: block-scope extern cannot name a local-class type (C2624), so the
   two scratch views hoist to file scope. Linkage is C in both spellings,
   matching the data definitions. */
struct daMip_StateReleasedInit_G { int w[2]; };
struct daMip_Mtx43 { s32 m[12]; };
extern "C" {
struct daMip_StateReleasedInit_G data_ov085_021305c0;
struct daMip_Mtx43 data_020a0e68;
}
    ...
    if (_ZN9Animation8FinishedEv(c + 0x350) != 0) {
        ...
        case 3:
            *(s16*)(c + 0x100) = (r & 0x1f) + 0x1e;
            _ZN9ModelAnim7SetAnimEP8BCA_Filei5Fix12IiEj(c + 0x300, ((void **)&data_ov085_021305c0)[1], 0, 0x1000, 0);
            *(int*)(c + 0x41c) = 0;
            break;
        }
    }
...
int daMip_c::StateIdleInit()
{
  ...
  _ZN9ModelAnim7SetAnimEP8BCA_Filei5Fix12IiEj(p+0x300, ((void **)&data_ov085_021305c0)[1], 0, 0x1000, 0);
...
void daMip_c::UpdateMatrixAndShadow()
{
    ...
    *(struct daMip_Mtx43*)(c + 0x31c) = data_020a0e68;
    MulMat4x3Mat4x3(*(void**)(c + 0x314), (void*)(c + 0x31c), tmp);
    Matrix4x3_FromTranslation(&data_020a0e68,
        *(int*)(c + 0x5c) >> 3,
        (*(int*)(c + 0x60) - 0xe000) >> 3,
        *(int*)(c + 0x64) >> 3);
    *(struct daMip_Mtx43*)(c + 0x390) = data_020a0e68;
...
void daMip_c::UpdateCarriedMatrix()
{
    ...
    *(struct daMip_Mtx43*)(c + 0x31c) = *(struct daMip_Mtx43*)res;
...
void daMip_c::RenderMirrorImage()
{
    ...
    struct daMip_Mtx43 tmp;
    tmp = *(struct daMip_Mtx43 *)(c + 0x31c);
    ...
    *(struct daMip_Mtx43 *)(c + 0x31c) = tmp;
}
