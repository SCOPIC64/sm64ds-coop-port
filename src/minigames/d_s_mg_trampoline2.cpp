...
/* dScMgTrampoline2_c, the Trampoline Terror minigame scene.
 * This file began as the 42-function shadow translation unit generated by
 * tools/tubuild.py create and is now the manifest-backed production TU. It
 * owns the contiguous ov006 text run 0x021225ac..0x02124908 and data run
 * 0x0213fbc4..0x0213fd0c. The intact-object production policy verifies its
 * compiler-generated RTTI/vtable data, imported base RTTI, relocations,
 * symbol bindings, overlay bytes, and final ROM identity on every build.
 *
 ...
 * Promotion deleted the paths below; they remain listed only as provenance:
...
/* -------------------------------------------------------------------------- */
/* ROM ordinal 40 -- dScMgTrampoline2_c_classInit, 0x0212471c, size 0x18c */
/* -------------------------------------------------------------------------- */
...
int func_ov006_021227c8(char* c){
  __cxa_vec_cleanup(c+0x1a8, 5, 8, (void*)NullDestructor_0203d47c);
