...
/* HOST glue: callers outside this TU spell the Itanium C name. */
extern "C" void _ZN6Camera10LookAtExitER8dActor_c(void *s, void *a)
{ ((Camera *)s)->Camera::LookAtExit(*(struct dActor_c *)a); }
